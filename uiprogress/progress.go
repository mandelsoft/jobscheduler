...
import (
	...
	blocks2 "github.com/mandelsoft/jobscheduler/ttyprogress/blocks"
)
...
type Progress interface {
	...
	// NewBlock adds a new blocks.Block.
	// If the Progress is already closed nil is returned.
	NewBlock(view ...int) *blocks2.Block
...
func (p *_progress) NewBlock(view ...int) *blocks2.Block {
